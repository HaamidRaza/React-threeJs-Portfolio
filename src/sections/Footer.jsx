  ...
  return (
    <section className="c-space pt-7 mb-3 border-t border-black-300 flex justify-between items-center flex-wrap gap-5">
      <div className="flex gap-3">
        <>
          <a
            ...
            target="_blank"
            className="social-icon hover:bg-black-100"
          >
        ...
        <a
          href="https://www.linkedin.com/in/haamid-raza-shaikh-687468378/"
          target="_blank"
          className="social-icon hover:bg-black-100"
        >
          <img
      ...
      <p className="text-white-500">
        &copy; {new Date().getFullYear()} Haamid, All rights reserved.
      </p>
    </section>
  );
};
